// generated by tscfg 0.3.3 on Sun Sep 04 11:58:01 PDT 2016
  ...
  object Agraph {
    ...
    def build(c: scala.Option[com.typesafe.config.Config]): Agraph = {
      Agraph(
        ...
        c.map(c => if(c.hasPathOrNull("initDelay")) Some(c.getDuration("initDelay", java.util.concurrent.TimeUnit.SECONDS)) else None).get,
        c.get.getString("password"),

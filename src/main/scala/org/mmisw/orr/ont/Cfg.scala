// generated by tscfg 0.8.0 on Fri Feb 03 15:52:43 PST 2017
...
object Cfg {
  ...
  object Notifications {
    def apply(c: com.typesafe.config.Config): Cfg.Notifications = {
      Cfg.Notifications(
        recipientsFilename = if(c.hasPathOrNull("recipientsFilename")) Some(c.getString("recipientsFilename")) else None
      )
    }
  }
  ...
  def apply(c: com.typesafe.config.Config): Cfg = {
    Cfg(
      ...
      notifications   = Cfg.Notifications(c.getConfig("notifications")),

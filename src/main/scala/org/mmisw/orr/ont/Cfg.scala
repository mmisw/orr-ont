// generated by tscfg 0.3.3 on Thu Sep 01 12:15:32 PDT 2016
...
object Cfg {
  ...
  object Firebase {
    def apply(c: com.typesafe.config.Config) = build(Some(c))
    def apply() = build(None)
    def build(c: scala.Option[com.typesafe.config.Config]): Firebase = {
      Firebase(
  ...
  def build(c: scala.Option[com.typesafe.config.Config]): Cfg = {
    Cfg(
      ...
      Firebase.build(c.map(c => if (c.hasPath("firebase")) Some(c.getConfig("firebase")) else None).get),
